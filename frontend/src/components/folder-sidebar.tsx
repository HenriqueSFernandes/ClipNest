...
export function FolderSidebar({
	...
	const totalBookmarks = folders.reduce(
				...
				{viewMode === "ai-chat" ? (
					<div className="bg-gradient-to-r from-blue-50 to-purple-50 p-3 rounded-lg border border-blue-100">
						...
						<p className="text-xs text-blue-700">
							Ask the AI to &quot;show me bookmarks from [folder name]&quot; to
					...
					<div className="bg-gradient-to-r from-green-50 to-blue-50 p-3 rounded-lg border border-green-100">
						...
						<p className="text-xs text-green-700">
							Click on folders to filter bookmarks. Use the search bar and
							controls to organize your collection.
						</p>
					</div>
				)}
					...
					<div className="space-y-3">
						...
						<div className="space-y-2 text-xs">
							<div className="p-2 bg-gray-50 rounded text-gray-600">
								&quot;Summarize my {folders[0]?.name.toLowerCase()}{" "}
								bookmarks&quot;
							</div>
							<div className="p-2 bg-gray-50 rounded text-gray-600">
